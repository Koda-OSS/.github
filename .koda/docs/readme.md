...
For our core pillars, engineering principles, and the boundary between **Koda OSS** and **Koda-sh**, see the [**Manifest**](manifest).

## Getting Started

### Using Our Libraries
1.  **Browse Projects:** View our [Active Projects]() below.
...
1.  **Read the Manifest:** Review our [Manifest](manifest) for core pillars and how we build software.
...
* **[Manifest](manifest)** — Core pillars, engineering principles, and the Koda OSS / Koda-sh boundary.
...
See the [**Manifest**](manifest) for core pillars, our Fast / Clean / Secure engineering goals, and how we separate open-source work from proprietary products.
